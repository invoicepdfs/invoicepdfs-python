...
class BillingApi:
    ...
    def update_overage_settings(
        self,
        billing_overage_request: BillingOverageRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param billing_overage_request: (required)
        :type billing_overage_request: BillingOverageRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_overage_settings_serialize(
            billing_overage_request=billing_overage_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_overage_settings_with_http_info(
        self,
        billing_overage_request: BillingOverageRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BillingOverageResponse]:
        """Update Overage Settings
    ...
    @validate_call
    def update_overage_settings_without_preload_content(
        self,
        billing_overage_request: BillingOverageRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_overage_settings_serialize(
        self,
        billing_overage_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if billing_overage_request is not None:
            _body_params = billing_overage_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v1/billing/overage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
