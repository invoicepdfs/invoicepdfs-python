...
class ImportsApi:
    ...
    def _cancel_import_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/imports/{import_id}/cancel',
    ...
    def _confirm_import_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/imports/{import_id}/confirm',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _create_import_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if import_create_request is not None:
            _body_params = import_create_request
    ...
    def _get_import_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/imports/{import_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
