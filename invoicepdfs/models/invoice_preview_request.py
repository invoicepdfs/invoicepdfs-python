...
class InvoicePreviewRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["invoice_number", "document_type", "issue_date", "due_date", "currency", "locale", "business_profile_id", "customer_id", "ship_to", "line_items", "discounts", "shipping", "notes", "terms", "custom_fields", "payment", "branding", "template_id", "page_size"]
