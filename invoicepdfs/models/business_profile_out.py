...
class BusinessProfileOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["legal_name", "display_name", "contact_name", "email", "phone", "website", "tax_id", "address", "bank_account", "electronic_address", "default_currency", "default_locale", "default_timezone", "logo_file_id", "id", "created_at", "updated_at"]
