...
class DocumentOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "document_type", "number", "status", "issue_date", "due_date", "currency", "locale", "business_profile_id", "customer_id", "source_document_id", "reason", "data", "totals", "created_at", "updated_at", "finalized_at"]
