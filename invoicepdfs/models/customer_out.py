...
class CustomerOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "contact_name", "email", "phone", "tax_id", "billing_address", "shipping_address", "electronic_address", "metadata", "id", "created_at", "updated_at"]
